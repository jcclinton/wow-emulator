...
field_data('OBJECT_FIELD_GUID') -> {16#00, uint32};
field_data('OBJECT_FIELD_TYPE') -> {16#02, uint32};
field_data('OBJECT_FIELD_ENTRY') -> {16#03, uint32};
field_data('OBJECT_FIELD_SCALE_X') -> {16#04, uint32};
field_data('OBJECT_FIELD_PADDING') -> {16#05, uint32};
field_data('OBJECT_END') -> {16#06, uint32};

field_data('ITEM_FIELD_OWNER') -> {fields('OBJECT_END') + 16#00, uint32};
field_data('ITEM_FIELD_CONTAINED') -> {fields('OBJECT_END') + 16#02, uint32};
field_data('ITEM_FIELD_CREATOR') -> {fields('OBJECT_END') + 16#04, uint32};
field_data('ITEM_FIELD_GIFTCREATOR') -> {fields('OBJECT_END') + 16#06, uint32};
...
field_data('ITEM_FIELD_SPELL_CHARGES') -> {fields('OBJECT_END') + 16#0A, uint32};
field_data('ITEM_FIELD_SPELL_CHARGES_01') -> {fields('OBJECT_END') + 16#0B, uint32};
field_data('ITEM_FIELD_SPELL_CHARGES_02') -> {fields('OBJECT_END') + 16#0C, uint32};
field_data('ITEM_FIELD_SPELL_CHARGES_03') -> {fields('OBJECT_END') + 16#0D, uint32};
field_data('ITEM_FIELD_SPELL_CHARGES_04') -> {fields('OBJECT_END') + 16#0E, uint32};
...
field_data('ITEM_FIELD_RANDOM_PROPERTIES_ID') -> {fields('OBJECT_END') + 16#26, uint32};
...
field_data('CONTAINER_FIELD_SLOT_1') -> {fields('ITEM_END') + 16#02, uint32};
field_data('CONTAINER_FIELD_SLOT_LAST') -> {fields('ITEM_END') + 16#38, uint32};
field_data('CONTAINER_END') -> {fields('ITEM_END') + 16#3A, uint32};

field_data('UNIT_FIELD_CHARM') -> {16#00 + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_SUMMON') -> {16#02 + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_CHARMEDBY') -> {16#04 + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_SUMMONEDBY') -> {16#06 + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_CREATEDBY') -> {16#08 + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_TARGET') -> {16#0A + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_PERSUADED') -> {16#0C + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_CHANNEL_OBJECT') -> {16#0E + fields('OBJECT_END'), uint32};
...
field_data('UNIT_FIELD_BYTES_0') -> {16#1E + fields('OBJECT_END'), uint32};
...
field_data('UNIT_FIELD_BASEATTACKTIME') -> {16#78 + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_OFFHANDATTACKTIME') -> {16#79 + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_RANGEDATTACKTIME') -> {16#7a + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_BOUNDINGRADIUS') -> {16#7b + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_COMBATREACH') -> {16#7c + fields('OBJECT_END'), uint32};
...
field_data('UNIT_FIELD_MINDAMAGE') -> {16#80 + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_MAXDAMAGE') -> {16#81 + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_MINOFFHANDDAMAGE') -> {16#82 + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_MAXOFFHANDDAMAGE') -> {16#83 + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_BYTES_1') -> {16#84 + fields('OBJECT_END'), uint32};
...
field_data('UNIT_FIELD_STAT0') -> {16#90 + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_STAT1') -> {16#91 + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_STAT2') -> {16#92 + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_STAT3') -> {16#93 + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_STAT4') -> {16#94 + fields('OBJECT_END'), uint32};
...
field_data('UNIT_FIELD_BYTES_2') -> {16#9e + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_ATTACK_POWER') -> {16#9f + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_ATTACK_POWER_MODS') -> {16#a0 + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_ATTACK_POWER_MULTIPLIER') -> {16#a1 + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_RANGED_ATTACK_POWER') -> {16#a2 + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_RANGED_ATTACK_POWER_MODS') -> {16#a3 + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_RANGED_ATTACK_POWER_MULTIPLIER') -> {16#a4 + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_MINRANGEDDAMAGE') -> {16#a5 + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_MAXRANGEDDAMAGE') -> {16#a6 + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_POWER_COST_MODIFIER') -> {16#a7 + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_POWER_COST_MODIFIER_01') -> {16#a8 + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_POWER_COST_MODIFIER_02') -> {16#a9 + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_POWER_COST_MODIFIER_03') -> {16#aa + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_POWER_COST_MODIFIER_04') -> {16#ab + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_POWER_COST_MODIFIER_05') -> {16#ac + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_POWER_COST_MODIFIER_06') -> {16#ad + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_POWER_COST_MULTIPLIER') -> {16#ae + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_POWER_COST_MULTIPLIER_01') -> {16#af + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_POWER_COST_MULTIPLIER_02') -> {16#b0 + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_POWER_COST_MULTIPLIER_03') -> {16#b1 + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_POWER_COST_MULTIPLIER_04') -> {16#b2 + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_POWER_COST_MULTIPLIER_05') -> {16#b3 + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_POWER_COST_MULTIPLIER_06') -> {16#b4 + fields('OBJECT_END'), uint32};
field_data('UNIT_FIELD_PADDING') -> {16#b5 + fields('OBJECT_END'), uint32};
field_data('UNIT_END') -> {16#b6 + fields('OBJECT_END'), uint32};

field_data('PLAYER_DUEL_ARBITER') -> {16#00 + fields('UNIT_END'), uint32};
...
field_data('PLAYER_BYTES') -> {16#05 + fields('UNIT_END'), uint32};
field_data('PLAYER_BYTES_2') -> {16#06 + fields('UNIT_END'), uint32};
field_data('PLAYER_BYTES_3') -> {16#07 + fields('UNIT_END'), uint32};
...
field_data('PLAYER_VISIBLE_ITEM_1_CREATOR') -> {16#46 + fields('UNIT_END'), uint32};
...
field_data('PLAYER_FIELD_INV_SLOT_HEAD') -> {16#12a + fields('UNIT_END'), uint32};
field_data('PLAYER_FIELD_PACK_SLOT_1') -> {16#158 + fields('UNIT_END'), uint32};
field_data('PLAYER_FIELD_PACK_SLOT_LAST') -> {16#176 + fields('UNIT_END'), uint32};
field_data('PLAYER_FIELD_BANK_SLOT_1') -> {16#178 + fields('UNIT_END'), uint32};
field_data('PLAYER_FIELD_BANK_SLOT_LAST') -> {16#1a6 + fields('UNIT_END'), uint32};
field_data('PLAYER_FIELD_BANKBAG_SLOT_1') -> {16#1a8 + fields('UNIT_END'), uint32};
field_data('PLAYER_FIELD_BANKBAG_SLOT_LAST') -> {16#ab2 + fields('UNIT_END'), uint32};
field_data('PLAYER_FIELD_VENDORBUYBACK_SLOT_1') -> {16#1b4 + fields('UNIT_END'), uint32};
field_data('PLAYER_FIELD_VENDORBUYBACK_SLOT_LAST') -> {16#1ca + fields('UNIT_END'), uint32};
field_data('PLAYER_FIELD_KEYRING_SLOT_1') -> {16#1cc + fields('UNIT_END'), uint32};
field_data('PLAYER_FIELD_KEYRING_SLOT_LAST') -> {16#20a + fields('UNIT_END'), uint32};
field_data('PLAYER_FARSIGHT') -> {16#20c + fields('UNIT_END'), uint32};
field_data('PLAYER_FIELD_COMBO_TARGET') -> {16#20e + fields('UNIT_END'), uint32};
...
field_data('PLAYER_BLOCK_PERCENTAGE') -> {16#396 + fields('UNIT_END'), uint32};
field_data('PLAYER_DODGE_PERCENTAGE') -> {16#397 + fields('UNIT_END'), uint32};
field_data('PLAYER_PARRY_PERCENTAGE') -> {16#398 + fields('UNIT_END'), uint32};
field_data('PLAYER_CRIT_PERCENTAGE') -> {16#399 + fields('UNIT_END'), uint32};
field_data('PLAYER_RANGED_CRIT_PERCENTAGE') -> {16#39a + fields('UNIT_END'), uint32};
...
field_data('PLAYER_FIELD_POSSTAT0') -> {16#3DD + fields('UNIT_END'), uint32};
field_data('PLAYER_FIELD_POSSTAT1') -> {16#3DE + fields('UNIT_END'), uint32};
field_data('PLAYER_FIELD_POSSTAT2') -> {16#3DF + fields('UNIT_END'), uint32};
field_data('PLAYER_FIELD_POSSTAT3') -> {16#3E0 + fields('UNIT_END'), uint32};
field_data('PLAYER_FIELD_POSSTAT4') -> {16#3E1 + fields('UNIT_END'), uint32};
field_data('PLAYER_FIELD_NEGSTAT0') -> {16#3E2 + fields('UNIT_END'), uint32};
field_data('PLAYER_FIELD_NEGSTAT1') -> {16#3E3 + fields('UNIT_END'), uint32};
field_data('PLAYER_FIELD_NEGSTAT2') -> {16#3E4 + fields('UNIT_END'), uint32};
field_data('PLAYER_FIELD_NEGSTAT3') -> {16#3E5 + fields('UNIT_END'), uint32};
field_data('PLAYER_FIELD_NEGSTAT4') -> {16#3E6 + fields('UNIT_END'), uint32};
field_data('PLAYER_FIELD_RESISTANCEBUFFMODSPOSITIVE') -> {16#3E7 + fields('UNIT_END'), uint32};
field_data('PLAYER_FIELD_RESISTANCEBUFFMODSNEGATIVE') -> {16#3EE + fields('UNIT_END'), uint32};
...
field_data('PLAYER_FIELD_MOD_DAMAGE_DONE_PCT') -> {16#403 + fields('UNIT_END'), uint32};
field_data('PLAYER_FIELD_BYTES') -> {16#40A + fields('UNIT_END'), uint32};
...
field_data('PLAYER_FIELD_BYTES2') -> {16#430 + fields('UNIT_END'), uint32};
field_data('PLAYER_FIELD_WATCHED_FACTION_INDEX') -> {16#431 + fields('UNIT_END'), uint32};
field_data('PLAYER_FIELD_COMBAT_RATING_1') -> {16#432 + fields('UNIT_END'), uint32};
field_data('PLAYER_END') -> {16#446 + fields('UNIT_END'), uint32};

field_data('OBJECT_FIELD_CREATED_BY') -> {fields('OBJECT_END') + 16#00, uint32};
field_data('GAMEOBJECT_DISPLAYID') -> {fields('OBJECT_END') + 16#02, uint32};
field_data('GAMEOBJECT_FLAGS') -> {fields('OBJECT_END') + 16#03, uint32};
field_data('GAMEOBJECT_ROTATION') -> {fields('OBJECT_END') + 16#04, uint32};
field_data('GAMEOBJECT_STATE') -> {fields('OBJECT_END') + 16#08, uint32};
field_data('GAMEOBJECT_POS_X') -> {fields('OBJECT_END') + 16#09, uint32};
field_data('GAMEOBJECT_POS_Y') -> {fields('OBJECT_END') + 16#0A, uint32};
field_data('GAMEOBJECT_POS_Z') -> {fields('OBJECT_END') + 16#0B, uint32};
field_data('GAMEOBJECT_FACING') -> {fields('OBJECT_END') + 16#0C, uint32};
...
field_data('DYNAMICOBJECT_CASTER') -> {fields('OBJECT_END') + 16#00, uint32};
field_data('DYNAMICOBJECT_BYTES') -> {fields('OBJECT_END') + 16#02, uint32};
field_data('DYNAMICOBJECT_SPELLID') -> {fields('OBJECT_END') + 16#03, uint32};
field_data('DYNAMICOBJECT_RADIUS') -> {fields('OBJECT_END') + 16#04, uint32};
field_data('DYNAMICOBJECT_POS_X') -> {fields('OBJECT_END') + 16#05, uint32};
field_data('DYNAMICOBJECT_POS_Y') -> {fields('OBJECT_END') + 16#06, uint32};
field_data('DYNAMICOBJECT_POS_Z') -> {fields('OBJECT_END') + 16#07, uint32};
field_data('DYNAMICOBJECT_FACING') -> {fields('OBJECT_END') + 16#08, uint32};
field_data('DYNAMICOBJECT_PAD') -> {fields('OBJECT_END') + 16#09, uint32};
field_data('DYNAMICOBJECT_END') -> {fields('OBJECT_END') + 16#0A, uint32};

field_data('CORPSE_FIELDS_OWNER') -> {fields('OBJECT_END') + 16#00, uint32};
field_data('CORPSE_FIELDS_FACING') -> {fields('OBJECT_END') + 16#02, uint32};
field_data('CORPSE_FIELDS_POS_X') -> {fields('OBJECT_END') + 16#03, uint32};
field_data('CORPSE_FIELDS_POS_Y') -> {fields('OBJECT_END') + 16#04, uint32};
field_data('CORPSE_FIELDS_POS_Z') -> {fields('OBJECT_END') + 16#05, uint32};
...
field_data('CORPSE_FIELDS_BYTES_1') -> {fields('OBJECT_END') + 16#1A, uint32};
field_data('CORPSE_FIELDS_BYTES_2') -> {fields('OBJECT_END') + 16#1B, uint32};
